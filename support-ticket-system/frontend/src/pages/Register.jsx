    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '420px', position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ color: isDark ? 'white' : '#111827', fontSize: '28px', fontWeight: '700', margin: 0 }}>Create account</h1>
          <p style={{ color: isDark ? '#9ca3af' : '#6b7280', marginTop: '8px', fontSize: '14px' }}>Start managing your support tickets</p>
        </div>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: '20px' }}>
              <label style={{ display: 'block', color: isDark ? '#d1d5db' : '#374151', fontSize: '13px', fontWeight: '500', marginBottom: '8px' }}>Full Name</label>
